import {
  ...
  export class SensorHub {
    ...
    createSensorHubAccessory() {
      ...
      sensorHubAccessory.addService(this.createLightSensorService());
      sensorHubAccessory.addService(this.createOnBoardTemperatureSensorService());
      sensorHubAccessory.addService(this.createOnBoardHumiditySensorService());
      sensorHubAccessory.addService(this.createMotionDetectorService());
    ...
    createLightSensorService(): Service {
    ...
    createOnBoardTemperatureSensorService(): Service {
    ...
    createOnBoardHumiditySensorService(): Service {
    ...
    createMotionDetectorService(): typeof Service | Service {
